module.exports = module.exports =
    ...
    "no app message": """
        В данный момент у Вас нет ни одного приложения для Cozy.
        Проследуйте <a href="#applications">Магазин Cozy</a> и установите новые приложения!
        """

    "welcome to app store": """
        Добро пожаловать в Ваш магазин Cozy, устанавливайте приложения отсюда или добавьте одно из списка доступных.
        """

    "installed everything": "На данный момент Вы установили все доступные приложения!"
    "already similarly named app": """
        У Вас уже есть приложение с похожим именем.
        """
    ...
    "Once updated, this application will require the following permissions:": """
        Как только приложение будет обновлено, потребуются следующие разрешения:
    """
    ...
    "introduction market": """
        Добро пожаловать в магазин Cozy!
    ...
    "warning unofficial app": """
        Это приложение от сообщества и не управляется командой Cozy.
    ...
    "app msg":  'Если ошибка повторяется, Вы можете связаться с нами по адресу contact@cozycloud.cc' +
                'или по IRC #cozycloud на сервере irc.freenode.net.'
    'more details': "Подробности"

    'noapps':
        'first steps': """
            Вы можете <a href="%{wizard}">использовать помощника</a> для установки и настройки Ваших приложений,
            или Вы можете пройти <a href="%{quicktour}">краткий обзор</a> и узнать возможности Cozy.
        """
        'customize your cozy': """
            Вы можете также <a href="%{account}">проследовать в настройки</a> и изменить Ваш Cozy,
    ...
    'installwizard':
        ...
        'welcome content': """
            <p>Этот помощник поможет Вам выбрать, установить и настроить приложения для Вашего Cozy.</p>
        ...
        'files content': """
            <p>Хотите ли Вы, чтобы приложение хранило Ваши персональные файлы и папки, и разрешало защищенный доступ к ним?</p>
        """
        'emails title': "Настройте Почту"
        'emails content': """
            <p>Хотите ли Вы, чтобы клиент электронной почты связывался со всеми Вашими почтовыми ящиками, и обеспечивал Вам доступ к единому почтовому ящику?</p>
        """
        'contacts title': "Настройте Контакты"
        'contacts content': """
            <p>Хотите ли Вы, чтобы приложение Контакты управляло Вашей адресной книгой и позволяло получить мгновенный доступ к Вашим друзьям?</p>
        ...
        'calendar content': """
            <p>Хотите ли Вы, чтобы приложение Календарь помогло Вам устроить Вашу жизнь?</p>
            <p><small>Включив это приложение, Вы также включите приложение Синхронизация, которое необходимо для синхронизации Ваших данных со смартфоном и настольными приложениями.</small></p>
        """
        'photos title': "Настройте Фото"
        'photos content': """
            <p>Хотите ли Вы, чтобы приложение хранило Ваши фотографии и альбомы, и помогало Вам делиться ими с Вашими друзьями и семьёй?</p>
        ...
        'thanks content': """
            <p>Это так легко! Вы только что настроили Cozy для работы со следующими приложениями:</p>
        """
    ...
    'quicktourwizard':
        ...
        'apps content': """
            <p>По умолчанию Cozy предлагает 5 приложений:</p>
            <ul>
        ...
        'sync content': """
            <p><strong>Контакты и Календари</strong></p>
<p>
...
<li><a href="http://cozy.io/en/mobile/calendar.html">Синхронизация Календаря</a></li>
        ...
        'import content': """
        <p>Большинство инструментов позволяет Вам экспортировать события календаря в формате .ical и Ваши контакты в формате .vcard или .vcf. Как только у Вас появятся нужные файлы, Вы можете импортировать их в Cozy при помощи инструментов импорта, доступных в приложениях Контакты и Календари.
        </p>
        <p>
