...
module.exports = {
    ...
    "2fa strategy hotp": "Vous utilisez la méthode d'authentification HOTP (basé sur un compteur).",
    "2fa strategy totp": "Vous utilisez la méthode d'authentification TOTP (basé sur le temps).",
    ...
    "help direct title": "Ecrivez-nous directement",
    "help documentation title": "Documentation",
...
module.exports = {
    ...
    "2fa strategy hotp": "HOTP 2FA ストラテジーを使用しています (カウンターに基づく)。",
    "2fa strategy totp": "TOTP 2FA ストラテジーを使用しています (タイマーに基づく)。",
...
module.exports = {
    ...
    "2fa strategy hotp": "Używasz metody HOTP 2FA (bazującej na liczniku).",
    "2fa strategy totp": "Używasz metody TOTP 2FA (bazującej na czasie).",
...
module.exports = {
    ...
    "2fa strategy hotp": "Вы используете HOTP 2ФА схему (по счетчику).",
    "2fa strategy totp": "Вы используете TOTP 2ФА схему (по таймеру).",
