...
module.exports = {
  ...
  updateInstance: function(req, res, next) {
    var background, connectedOnce, domain, helpUrl, locale, _ref;
    _ref = req.body, domain = _ref.domain, locale = _ref.locale, helpUrl = _ref.helpUrl, background = _ref.background, connectedOnce = _ref.connectedOnce;
