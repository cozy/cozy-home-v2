...
var AppManager, Application, Manifest, NotificationsHelper, TIME_BETWEEN_UPDATE_CHECKS, UpdateNotifier, fs, mark_broken, printit, randomString, request, saveIcon, send_error, send_error_socket, slugify, startedApplications;
  ...
  Application.all(function(err, apps) {
    ...
    _fn = (function(_this) {
      return function() {
        ...
        return app.checkForUpdate(function(eru, setUpdate) {
          if (eru != null) {
