...
var Application, Manifest, autostop, exec, fs, log, manager, markBroken, randomString, request, saveIcon, sendError, sendErrorSocket, slugify, startedApplications, updateApp;
          ...
          return manager.installApp(appli, function(err, result) {
            ...
            if (result.drone != null) {
              ...
              return appli.save(function(err) {
                ...
                return saveIcon(appli, function(err) {
                  if (err != null) {
                    console.log(err.stack);
                  } else {
                    console.info('icon attached');
