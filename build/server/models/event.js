...
Event.prototype.getAlarms = function(userTimezone) {
  var alarm, alarms, cozyAlarm, duration, endDate, event, i, in24h, j, key, len, len1, now, ref, ref1, startDate, startDates, trigg, unitValues, value;
  alarms = [];
  ref1 = (ref = this.alarms) != null ? ref.items : void 0;
