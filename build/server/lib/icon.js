...
icons.getPath = function(root, appli) {
  var basePath, err, extension, homeBasePath, iconPath, marketApp, pngPath, result, svgPath, _ref;
  _ref = market.getApp(appli.slug), err = _ref[0], marketApp = _ref[1];
  iconPath = null;
  ...
  if ((iconPath == null) && (marketApp != null)) {
    homeBasePath = path.join(process.cwd(), 'client/app/assets');
