...
module.exports = AlarmManager = (function() {
  ...
  AlarmManager.prototype.addEventCounters = function(event) {
    var cozyAlarm, cozyAlarms, i, len, ref, results;
    if ((event.alarms != null) && ((ref = event.alarms.items) != null ? ref.length : void 0) > 0) {
  ...
  AlarmManager.prototype.handleNotification = function(alarm) {
    var agenda, contentKey, contentOptions, data, event, message, ref, ref1, ref2, resource, titleKey, titleOptions;
