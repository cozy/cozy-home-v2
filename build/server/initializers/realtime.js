...
var AlarmManager, Application, CozyInstance, Notification, NotificationsHelper, RealtimeAdapter, SharingManager, User, async, autostop, localizationManager, notifhelper;
...
module.exports = function(app, callback) {
  ...
  realtime.on('sharing.*', function(event, id) {
    return SharingManager.handleNotification(event, id, function(err) {
      return callback(err);
    });
  });
