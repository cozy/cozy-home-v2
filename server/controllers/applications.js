...
(function() {
  var AppManager, Application, DescriptionManager, PermissionsManager, WidgetManager, fs, mark_broken, randomString, request, saveIcon, send_error, send_error_socket, slugify;
  ...
  WidgetManager = require('../lib/widget').WidgetManager;
    ...
    install: function(req, res, next) {
      ...
      return Application.all({
        ...
        return permissions.get(req.body, function(err, docTypes) {
          ...
          return widget.get(req.body, function(err, widget) {
            if (err) {
              return send_error(res, err);
            }
