module.exports =
    ...
    "application is installing" : """
        Eine App wird bereits installiert.
    ...
    "already similarly named app": """
        Sie haben bereits eine App mit gleichem Namen.
        """
    ...
    "Once updated, this application will require the following permissions:": """
        Einmal aktualisiert, benötigt diese App folgende Rechte:
    """
    ...
    "warning unofficial app": """
        Diese App is eine aus der Gemeinschaft und wird nicht durch das Cozy Team betreut.
    ...
    'noapps':
        'first steps': """
            Sie können <a href="%{wizard}">unseren Wizard benutzen</a> um Hilfe bei der Installation und der Konfiguration Ihrer Apps zu erhalten,
    ...
    'installwizard':
        ...
        'welcome content': """
            <p>Dieser Wizard wird Ihnen dabei helfen auf Ihrem Cozy, Apps auszuwählen, installieren und einzurichten.</p>
        ...
        'files content': """
            <p>Möchte Sie eine App zum Speichern Ihrer persönlichen Dateien und Ordner, sicher erreichbar von überall?</p>
        """
        'emails title': "Emails App konfigurieren"
        'emails content': """
            <p>Möchten Sie einen E-Mail Client der mit all Ihren E-Mail Providern verbunden ist, so haben Sie Zugriff auf einen einheitlichen Briefkasten erreichbar von überall?</p>
        """
        ...
        'calendar content': """
            <p>Möchten Sie eine Kalendar App um Ihnen zu helfen Ihr Leben zu organisieren?</p>
            <p><small>Aktivieren dieser App ermöglicht auch die Verwendung der Sync App um Daten mit Ihrem Smartphone und den Computer Programmen zu synchronisieren.</small></p>
        """
        'photos title': "Photos App konfigurieren"
        'photos content': """
            <p>Möchten Sie eine App um Ihre Fotos und Albums zu speichern, und Ihnen zu helfen diese mit Freunden und Familie zu teilen?</p>
        ...
        'thanks title': "Fertig!"
        'thanks content': """
            <p>Es ist so einfach! Sie haben Ihr Cozy mit den folgenden Apps personalisiert:</p>
        """
    ...
    'quicktourwizard':
        ...
        'welcome content': """
            <p>Wilkommen zu Ihrem brand neuen Cozy.</p>
        ...
        'apps content': """
            <p><img src="/img/config-apps.png"><strong>App Verwaltung: </strong>Hier können Sie den Status Ihrer Apps verwalten: starten, stoppen, entfernen…</p>
        ...
        'help content': """
            <p><img src="/img/configuration.png"><strong>Konfiguration: </strong>Um sicher zu stellen, dass Ihr Cozy das macht, was Sie möchten, sehen Sie sich die Einstellungen an.</p>
        ...
        'sync content': """
            <p>Um mehr über Daten Synchronisation zu lernen, bitte schauen Sie sich die folgenden Ressourcen an:</p>
            <ul>
