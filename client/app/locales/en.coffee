module.exports =
    ...
    "already similarly named app": """
        You already have an app with a similar name.
        """
    ...
    "update stack": "Update"
    "refresh page": "Please wait, this page will automatically refresh in a few minutes."
    ...
    "Once updated, this application will require the following permissions:": """
        Once updated, this app will require the following permissions:
    """
    ...
    "introduction market": """
        Welcome to the Cozy app store. Here you can customize your Cozy
    ...
    "warning unofficial app": """
        This app is a community app and isn't maintained by the Cozy team.
    ...
    'noapps':
        'first steps': """
            You can <a href="%{wizard}">use our wizard</a> to help with installing and configuring your apps,
            or you can take a <a href="%{quicktour}">quick tour</a> and discover your Cozy features.
        """
        'customize your cozy': """
            You can also <a href="%{account}">go to your settings</a> and customize your Cozy,
    ...
    'installwizard':
        ...
        'files content': """
            <p>Do you want an app to store your personal files and folders, making them accessible securely from anywhere?</p>
        """
        'emails title': "Configure Emails app"
        'emails content': """
            <p>Do you want an email client linked to all your email providers, so you can access a private, unified mailbox from anywhere?</p>
        """
        'contacts title': "Configure Contacts app"
        'contacts content': """
            <p>Do you want a contacts app to manage your address book and give you instant access to your friends?</p>
        ...
        'calendar content': """
            <p>Do you want a calendar app to help you organize your life?</p>
            <p><small>Enabling this app will also enable the Sync app to synchronize data with your smartphone and desktop apps.</small></p>
        """
        ...
        'thanks title': "Done!"
        'thanks content': """
            <p>It's that easy! You've just personalized your Cozy with the following apps:</p>
        """
